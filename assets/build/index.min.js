...
var $=require("./libs/jquery");window.jQuery=$,window.$=$;var tilt=require("tilt.js");$(document).ready(function(){$(".project").tilt({glare:!0,maxGlare:.2,perspective:1e3,maxTilt:8,scale:1.03,reset:!0,speed:4e3})});
},{"./libs/jquery":2,"tilt.js":3}],2:[function(require,module,exports){
